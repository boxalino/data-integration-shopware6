...
class Price extends AttributeHandler
{
    ...
    public function getValues() : array
    {
        ...
        foreach ($this->getData(AttributeHandlerInterface::ATTRIBUTE_TYPE_PRICE) as $item)
        {
            $listPrices = [];
            $prices = [];
            ...
            $content[$item[$this->getInstantUpdateIdField()]][AttributeHandlerInterface::ATTRIBUTE_TYPE_PRICE] = $schema;
        }
